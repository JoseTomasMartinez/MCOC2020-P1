...
* #Entrega 5
* P1. Utilizando la función leer_eof.py se pudieron determinar las coordenadas de cada posición en todos los tiempos. El gráficos queda de la sigueinte forma:
